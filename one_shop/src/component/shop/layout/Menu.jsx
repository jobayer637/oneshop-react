                    ...
                    <div className="container">
                        ...
                        <div id="navbar" className="navbar-collapse collapse text-center">
                            <ul className="nav navbar-nav">
                                ...
                                <li className="dropdown ">
                                   <NavLink exact to="/shop"><a href="shop">Shop</a></NavLink>
                                </li>

                                <li className="dropdown ">
                                   <NavLink exact to="/contact"><a href="contact">Contact</a></NavLink>
                                </li>
                                ...
                                <li className="dropdown full-width dropdown-slide">
                                    ...
                                    <div className="dropdown-menu">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-3 col-xs-12">
                                                <a href="shop">
                                                    <img className="img-responsive" src="images/shop/header-img.jpg" alt="menuImage" />
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li className="dropdown ">
                                   <NavLink exact to="/login"><a href="login">Login</a></NavLink>
                                </li>
